...
const TermsPage: React.FC = () => {
  useEffect(() => {
    ...
    metaDesc.setAttribute('content', "Read the Terms of Service for Architectorly. Understand the rules for using Pakistan's leading architectural directory.");
    ...
    robots.setAttribute('content', 'noindex, follow'); // Terms pages don't need to be primary search landing pages
