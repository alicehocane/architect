...
const AboutPage: React.FC = () => {
  useEffect(() => {
    ...
    document.title = "About Architectorly | We Connect You With Top Architects";

    // 2. Dynamic Meta Description
    const pageDesc = "Learn about Architectorly. We are Pakistan's #1 free directory for finding verified architects, home designers, and map makers. Simple, fast, and trusted.";
