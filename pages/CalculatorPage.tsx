...
const CalculatorPage: React.FC = () => {
  ...
  useEffect(() => {
    // 1. Dynamic Title
    document.title = "Construction Cost Calculator 2025 | Architectorly";
    ...
    metaDesc.setAttribute('content', "Calculate house construction costs in Pakistan. Estimate budgets for 5 Marla, 10 Marla, and 1 Kanal homes based on 2025 market rates.");
