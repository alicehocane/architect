...
export const metadata: Metadata = {
  title: "Privacy Policy | Architectorly Pakistan",
  description: "Read the Privacy Policy for Architectorly. We keep your data safe and do not sell your information. Learn more.",
  robots: {
    index: false,
    follow: true,
  },
